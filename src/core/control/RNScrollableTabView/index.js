...
const ViewPagerAndroid = PagerView;
...
const ImageTabBar = require('./ImageTabBar');
const ScrollableImageTabBar = require('./ScrollableImageTabBar');
...
const ScrollableTabView = createReactClass({
  ...
  statics: {
    ...
    FacebookTabBar,
    ImageTabBar,
    ScrollableImageTabBar,
  },
  scrollOnMountCalled: false,

  propTypes: {
    tabBarPosition: PropTypes.oneOf(['top', 'bottom', 'overlayTop', 'overlayBottom','floating']),
  ...
  renderTabBar(props) {
    if (this.props.renderTabBar === false) {
      ...
      return <DefaultTabBar accessible={true} accessibilityLabel={'TabBar'} {...props} />;
    }
  },
  ...
  render() {
    ...
    let tabBarProps = {
      ...
      tabs: this._children().map((child) => { return { label: child.props.tabLabel, disabled: child.props.tabDisabled } }),
    ...
    if (this.props.tabBarActiveTextPreset) {
      tabBarProps.activeTextPreset = this.props.tabBarActiveTextPreset;
    }
    if (this.props.tabBarInactiveTextPreset) {
      tabBarProps.inactiveTextPreset = this.props.tabBarInactiveTextPreset;
    }
    ...
    return <View style={[styles.container, this.props.style,]} onLayout={this._handleLayout}>
      <View style={this.props.hideTabBar && this.props.tabBarPosition !== 'floating' ? { width: 0, height: 0, overflow: 'hidden' } : {}}>
        {this.props.tabBarPosition === 'top' && this.renderTabBar(tabBarProps)}
      </View>
      {this.renderScrollableContent()}
      {this.props.tabBarPosition === 'floating' &&
        <Animated.View style={this.props.tabBarFloatingStyle}>
