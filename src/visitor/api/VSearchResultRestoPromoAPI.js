...
export class VSearchResultRestoPromoAPI extends SGBaseScreen {

    static async getAllSearchResultRestoPromo(language, keyword, filterData, sortData,pagingParam) {
