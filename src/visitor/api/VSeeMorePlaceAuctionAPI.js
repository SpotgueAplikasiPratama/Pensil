...
export class VSeeMorePlaceAuctionAPI extends SGBaseScreen {

    static async getPlaceAuctionList(contentKey, arrFilter, arrSort,pagingParam) {
        ...
        var res = await SGHelperAPICall.callAPISync('SearchBuildingHighlightSeeMoreAuction', {
            filter: filtersort.filter,
            sort: filtersort.sort,
            paging:pagingParam
        })
