...
export class VSearchResultFavoriteRestoPromoAPI extends SGBaseScreen {

    static async getAllSearchResultFavoriteRestoPromo(language, keyword, filterData, sortData,pagingParam) {
        ...
        // }));
        // console.log(token)
        var res = await SGHelperAPICall.callAPISync('SearchUserFavRestoPromoListWithKeyword', {
            filter: filtersort.filter,
            sort: filtersort.sort,
            paging:pagingParam
        })
