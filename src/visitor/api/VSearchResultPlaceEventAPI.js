...
export class VSearchResultPlaceEventAPI extends SGBaseScreen {

    static async getAllSearchResultPlaceEvent(language, keyword, filterData, sortData,pagingParam) {
