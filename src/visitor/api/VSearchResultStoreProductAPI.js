...
export class VSearchResultStoreProductAPI extends SGBaseScreen {

    static async getAllSearchResultStoreProduct(language, keyword, filterData, sortData,pagingParam) {
        ...
        console.log('getAllSearchResultStoreProduct')
