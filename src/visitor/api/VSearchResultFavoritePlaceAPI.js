...
export class VSearchResultFavoritePlaceAPI extends SGBaseScreen {

    static async getAllSearchResultFavoritePlace(language, keyword, filterData, sortData,pagingParam) {
        ...
        var res = await SGHelperAPICall.callAPISync('SearchAllBuilding', {
