 ...
 */
 ...
 import { tbVLoyaltyRewardAPI } from '../../api/tbVLoyaltyRewardAPI';
 ...
 export class LoyaltyRewardDetailScreen extends SGBaseScreen {
     ...
     async tradePoint(data){
         try {
             var res = await tbVLoyaltyRewardAPI.UpdateLoyaltyReward(data.fID, this.props.route.params.dataLoyalty.fCardKey, this.props.route.params.dataLoyalty.fID, 'building', data.fType)
             if(res == true){
                 if(data.fTotalAvailable !== 0){
                     data.fTotalAvailable = data.fTotalAvailable -1;
                 }
                 this.totalPointAvailable = this.totalPointAvailable - this.data.fLoyaltyPoint;
     ...
     async componentDidMount() {
         if (this.props.route.params.fType === "store" || this.props.route.params.fType === 'resto'){
             this.baseRunSingleAPIWithRedoOption('getTenantLoyaltyRewardDetail', (async (v1) => { return tbVLoyaltyRewardAPI.getTenantLoyaltyRewardDetail(v1) }).bind(this,this.props.route.params.contentKey), ((v) => {
                 this.data = v
             ...
             this.baseRunSingleAPIWithRedoOption('getBuildingLoyaltyRewardDetail', (async (v1) => { return tbVLoyaltyRewardAPI.getBuildingLoyaltyRewardDetail(v1) }).bind(this,this.inputDetail), ((v) => {
                 this.data = v
                 console.log('data')
     ...
     async _checkReward(){
         ...
         if (this.props.route.params.fType === "store" || this.props.route.params.fType === 'resto'){
             this.baseRunSingleAPIWithRedoOption('getTenantLoyaltyRewardDetail', (async (v1) => { return tbVLoyaltyRewardAPI.getTenantLoyaltyRewardDetail(v1) }).bind(this,this.inputDetail), ((v) => {
     ...
     constructor(props, context, ...args) {
         ...
         this.inputDetail = {fID: this.props.route.params.contentKey, fCardKey: this.props.route.params.dataLoyalty.fCardKey}
         this.totalPointAvailable =this.props.route.params.dataLoyalty.fTotalPoint;
     }
     ...
     render() {
        ...
        //  console.log(this.props.route.params.dataLoyalty)
        console.log('------')
        console.log(data);
         return (
             <RootView dummyStatusBar accessible={true} accessibilityLabel={'RewardDetailScreenRootView'} style={style.mainContainer}>
                 ...
                 <View style={{width:w, justifyContent:'space-between', flexDirection:'row', paddingHorizontal: p*4}}>
                    ...
                    <Text preset={Text.preset.titleH3B} style={style.textPoint}>{SGLocalize.translate('RewardDetailScreen.LoyaltyPoint')} {this.totalPointAvailable}</Text>
                 </View>
