...
import { SGView as View, SGRootView as RootView, SGText as Text, SGIcon as Icon, SGScrollView as ScrollView, SGButton as Button, SGTouchableOpacity as TouchableOpacity, SGActivityIndicator as ActivityIndicator, SGImage as Image, SGDialogBox } from '../../../core/control';
...
export class RestoWaitingListDetailScreen extends SGBaseScreen {
    ...
    async _onSelectProfileResto() {
        ...
        this.baseAddAPIParallel('getRestoHomeProfile', (async (v1) => { return VRestoProfileAPI.getRestoHomeProfile(v1) }).bind(this, this.waitingListData.fStoreKey), ((v) => {           
            this.profileResto = v
        }).bind(this), (()=>{SGDialogBox.hideDialogBox(this.dbID3, true);}).bind(this));
       
        this.baseAddAPIParallel('getRestoSettings', (async (v1) => { return VRestoHomeAPI.getRestoSettings(v1); }).bind(this,this.waitingListData.fStoreKey), ((v) => {
            this.dataSetting = v;
        }).bind(this),  (()=>{SGDialogBox.hideDialogBox(this.dbID3, true)}).bind(this));
