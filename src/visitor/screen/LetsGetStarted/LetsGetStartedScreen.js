...
export class LetsGetStartedScreen extends SGBaseScreen {
    ...
    _onSkipPress() {
        ...
        var anonymousUserData = { fID: 'anonymous', fImageProfileJSON: [{ id: '993581f2-d951-45dc-ae6e-5041b7a16ff7', text: "", textPosition: "topLeft", low: { uri: image.spotgueLogoOnly.low.url, width: 480, height: 480 }, med: { uri: image.spotgueLogoOnly.med.url, width: 720, height: 720 }, high: { uri: image.spotgueLogoOnly.high.url, width: 1080, height: 1080 }, thumbnailLow: { uri: image.spotgueLogoOnly.low.url, width: 480, height: 480 }, thumbnailMed: { uri: image.spotgueLogoOnly.med.url, width: 720, height: 720 }, thumbnailHigh: { uri: image.spotgueLogoOnly.high.url, width: 1080, height: 1080 } }], fEmail: '', fPhoneNumber: '', fPassword: '', fSecurityQuestionKey: '', fQuestionAnswer: '', fName: '', fGender: '', fDOB: new Date(0), fLocation: '', fFamily: '', fFoodPreference: '', fLanguage: '', fCurrency: 'IDR', fCar: [], fImageSetting: 'med', fTrackingActive: 'N', fNotificationActive: 'N', fShortDescription: '', fReminderReservation: '', fTimeZoneSetting: new Date(0), fCountry: '', fProvince: '', fCity: '', fUrlInstagram: '', fUrlFacebook: '', fUrlTwitter: '', fFacebookID: '', fGoogleID: '', fRegisterMethod: '', fActive: 'Y', fCreatedBy: '', fCreatedDate: new Date(0), fLastModifiedBy: '', fLastModifiedDate: new Date(0) }
