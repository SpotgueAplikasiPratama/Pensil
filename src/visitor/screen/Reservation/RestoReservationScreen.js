...
export class RestoReservationScreen extends SGBaseScreen {
    ...
    constructor(props, context, ...args) {
        ...
        this.dataSetting = [];
        this.dataReservationNumber = [];
        this.doneRenderProfileResto = false;
    ...
    checkAPIBatchStatusAllDone() {
        ...
        this.doneRenderProfileResto = true;
    ...
    async _onRefreshData() {
        ...
        this.baseAddAPIParallel('getSettingReservationByContentKey', (async (v1) => { return tbVReservationAPI.getSettingReservationByContentKey(v1) }).bind(this,this.restoKey), ((v) => {
            this.dataSetting = v 
        }).bind(this), (()=>{SGDialogBox.hideDialogBox(this.dbID2, true);}).bind(this));
    ...
    async _onAddButton() {
        ...
        this.reservationData.fStoreKey = this.restoKey;
    ...
    render() {
        ...
        return (
            <RootView dummyStatusBar accessible={true} accessibilityLabel={'RestoReservationScreenRootView'} style={style.mainView1}>
                ...
                <Image accessible={true} accessibilityLabel={'RestoReservationScreenImage'} style={style.containerView1} source={{ uri: this.doneRenderProfileResto == true ? this.profileResto['fContent' + this._language.toUpperCase()].fStoreBackgroundImageJSON[0][this.imageSetting].uri : '' }}></Image>
                ...
                <View accessible={true} accessibilityLabel={'RestoReservationScreenDateTimeView'} style={style.containerView2_1}>
                    <View accessible={true} accessibilityLabel={'RestoReservationScreenDateView'} style={style.containerView2_2}>
                        <Text accessible={true} accessibilityLabel={'RestoReservationScreenDateText'} preset={Text.preset.titleH3} style={style.text3}>{SGHelperType.formatDate(new Date(), this._language)}</Text>
                    </View>
                    <View accessible={true} accessibilityLabel={'RestoReservationScreenTimeView'} style={style.containerView2_2}>
                        <Text accessible={true} accessibilityLabel={'RestoReservationScreenTimeText'} preset={Text.preset.titleH3} style={style.text3}>{SGHelperType.formatTime(new Date(), this._language)}</Text>
                    </View>
                </View>

                {this.doneRenderProfileResto &&
                ...
                {this.doneRenderProfileResto ?
                <ScrollView  accessible={true} accessibilityLabel={'RestoReservationScreenScrollView'} contentContainerStyle={{ bacgroundColor: 'white' }} showsHorizontalScrollIndicator={false}>
                    <View accessible={true} accessibilityLabel={'RestoReservationScreenResvAddView'}>
                        <Text accessible={true} accessibilityLabel={'RestoReservationScreenResvAddText1'} preset={Text.preset.titleH2B} style={style.text2}>{SGLocalize.translate('ReservationAddView.Text1')}</Text>
                        <ReservationForm screenAdd={true} accessible={true} accessibilityLabel={'RestoReservationScreenForm'} style={style.throwWHP} data={this.reservationData} userData={this.currentUserData} language={this._language} disabled={false} callback={this._forceUpdate.bind(this)}></ReservationForm>
                    ...
                    {this.doneRenderProfileResto &&
                    this.dataSetting.fOperationHour[Day].fActive == 'Y' &&
                    <View accessible={true} accessibilityLabel={'RestoReservationScreenButtonView'} style={style.containerView4}>
                        <Button preset={Button.preset.red} accessible={true} accessibilityLabel={'RestoReservationScreenCancelButton'} label={SGLocalize.translate('ReservationAddView.CancelButtonText')} style={style.button} onPress={() => { this.props.navigation.goBack() }}></Button>
                        <SGFormButton accessible={true} accessibilityLabel={'RestoReservationScreenAddButton'} shadow preset={SGFormButton.preset.v1} data={this.reservationData} label={SGLocalize.translate('ReservationAddView.AddButtonText')} onPress={this._onAddButton.bind(this)} />
                    </View>
                     }
                ...
                <BottomNavigationContainer accessible={true} accessibilityLabel={'RestoReservationScreenBottomNav'} blackTheme navigator={this.props.navigation} style={style.containerView3}></BottomNavigationContainer>
            </RootView>
        );
    }
}
