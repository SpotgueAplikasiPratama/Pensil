...
import { SGView as View, SGRootView as RootView, SGText as Text, SGIcon as Icon, SGTouchableOpacity as TouchableOpacity, SGPopView, SGScrollView as ScrollView, SGButton as Button, SGImage as Image, SGDialogBox } from '../../../core/control';
...
export class ViewWaitingListStoreScreen extends SGBaseScreen {
    ...
    constructor(props, context, ...args) {
        ...
        this.profileStore = this.props.route.params.profileStore;
    ...
    async _onCancelPressHandler(){
        try {
            ...
            // SGDialogBox.showFail(null, SGLocalize.translate("AlertMessage.Fail"), SGLocalize.translate("AlertMessage.FailCancelWaitingList"), SGLocalize.translate("AlertMessage.OK"), () => { SGDialogBox.hideDialogBox(this.dbID2) }, true)
        } catch (error) {
            SGDialogBox.hideDialogBox(this.dbID2, true);
    ...
    render() {
        ...
        return (
            <RootView dummyStatusBar dummyHeaderBar accessible={true} accessibilityLabel={'ViewWaitingListScreenRootView'} style={style.mainView1}>
                <Image accessible={true} accessibilityLabel={'ViewWaitingListScreenImage'} style={style.containerView1} source={{ uri: this.profileStore['fContent' + this._language.toUpperCase()].fStoreBackgroundImageJSON[0][this.imageSetting].uri }}></Image>
                ...
                <ScrollView accessible={true} accessibilityLabel={'ViewWaitingListScreenScrollView'} style={{}} contentContainerStyle={{ bacgroundColor: 'white' }}>
