...
export class DetailHelpScreen extends SGBaseScreen {
    ...
    render() {
        ...
        console.log(this.directoryDataSpotgue["fContentURL" + this._language]);
        return (
            <RootView dummyStatusBar accessible={true} accessibilityLabel={'DetailhelpScreenRootView'} style={style.v1}>
