...
export class SearchResultInThisRestoAuctionScreen extends SGBaseScreen {
    ...
    async _onRefreshAllItem(resetPaging = false) {
        ...
        if(resetPaging){
            ...
            this.baseAddAPIParallel('SearchRestoAuctionListWithKeyword', (async (v1,v2,v3,v4,v5,v6) => { return VSearchResultAuctionAPI.SearchRestoAuctionListWithKeyword(v1,v2,v3,v4,v5,v6); }).bind(this, this.Language, this.searchKeyword, this._filterData, this._sortData, this.restoKey,this.paging), ((v) => {
                this.data = v;
    ...
    async _onRefresh() {
        ...
        if(!this.refresh && !this.state.loading){
            ...
            this.baseRunSingleAPIWithRedoOption('SearchRestoAuctionListWithKeyword', (async (v1, v2, v3, v4, v5,v6) => {  return VSearchResultAuctionAPI.SearchRestoAuctionListWithKeyword(v1,v2,v3,v4,v5,v6); }).bind(this, this.Language, this.searchKeyword, this._filterData, this._sortData, this.restoKey,this.paging), ((v) => {
            this.data = v
            this.pagingCounter = this.data.length
            if(v.length<SGHelperType.getPaging())this.setState({stopPulling:true})
            else this.setState({stopPulling:false})
