...
export class SearchResultInThisPlaceStorePromoScreen extends SGBaseScreen {
    ...
    async _onRefreshAllItem(resetPaging = false) {
        ...
        if(resetPaging){
            ...
            this.baseAddAPIParallel('getSearchInBuildingPlaceStorePromo', (async (v1,v2,v3,v4,v5,v6) => { return VSearchInThisPlaceAPI.getSearchInBuildingPlaceStorePromo(v1,v2,v3,v4,v5,v6); }).bind(this,this.Language, this.searchKeyword, this._filterData, this._sortData,this.buildingKey,this.paging), ((v) => {
                this.data = v;
            ...
            // VSearchInThisPlaceAPI.getSearchInBuildingPlaceStorePromo(this.Language, this.searchKeyword, this._filterData, this._sortData,this.buildingKey,this.paging).then((v) => {
            //     this.data = v;
    ...
    async _onRefresh() {
        ...
        if(!this.refresh && !this.state.loading){
            ...
            this.baseRunSingleAPIWithRedoOption('getSearchInBuildingPlaceStorePromo', (async (v1, v2, v3, v4, v5,v6) => { return VSearchInThisPlaceAPI.getSearchInBuildingPlaceStorePromo(v1, v2, v3, v4, v5,v6) }).bind(this,this.Language, this.searchKeyword, this._filterData, this._sortData,this.buildingKey,this.paging), ((v) => {
            this.data = v
            this.pagingCounter = this.data.length
            if(v.length<SGHelperType.getPaging())this.setState({stopPulling:true})
            else this.setState({stopPulling:false})
    ...
    async _onLoad(){
        // try {
            if(!this.state.loading && !this.state.stopPulling){
                ...
                this.baseRunSingleAPIWithRedoOption('getSearchInBuildingPlaceStorePromo', (async (v1, v2, v3,v4,v5,v6) => {return VSearchInThisPlaceAPI.getSearchInBuildingPlaceStorePromo(v1, v2, v3,v4,v5,v6) }).bind(this, this.Language, this.searchKeyword, this._filterData, this._sortData,this.buildingKey,this.paging), ((v) => {           
                    var resData = v// await VSearchInThisPlaceAPI.getSearchInBuildingPlaceStorePromo(this.Language, this.searchKeyword, this._filterData, this._sortData,this.buildingKey,this.paging);
                    if(resData.length!==0){
    ...
    constructor(props, context, ...args) {
        ...
        this._filterData = filterDAO.getInThisPlaceStorePromoFilterDataSearch();
    ...
    render() {
        ...
        console.log('aw')
        return (
            <RootView dummyStatusBar dummyHeaderBar accessible={true} accessibilityLabel={'SearchResultStorePromoScreenRootView'} style={style.mainView1}>
