...
export class SearchResultInThisPlaceAuctionScreen extends SGBaseScreen {
    ...
    async _onRefreshAllItem(resetPaging = false) {
        ...
        if(resetPaging){
            ...
            this.baseAddAPIParallel('getSearchInBuildingPlaceAuction', (async (v1,v2,v3,v4,v5,v6) => { return VSearchInThisPlaceAPI.getSearchInBuildingPlaceAuction(v1,v2,v3,v4,v5,v6); }).bind(this,this.Language, this.searchKeyword, this._filterData, this._sortData,this.buildingKey,this.paging), ((v) => {
                this.data = v;
            ...
            // VSearchInThisPlaceAPI.getSearchInBuildingPlaceAuction(this.Language, this.searchKeyword, this._filterData, this._sortData,this.buildingKey,this.paging).then((v) => {
            //     this.data = v;
    ...
    async _onRefresh() {
        ...
        if(!this.refresh && !this.state.loading){
            ...
            this.baseRunSingleAPIWithRedoOption('getSearchInBuildingPlaceAuction', (async (v1, v2, v3, v4, v5,v6) => { return VSearchInThisPlaceAPI.getSearchInBuildingPlaceAuction(v1, v2, v3, v4, v5,v6) }).bind(this,this.Language, this.searchKeyword, this._filterData, this._sortData,this.buildingKey,this.paging), ((v) => {
            this.data = v
            this.pagingCounter = this.data.length
            if(v.length<SGHelperType.getPaging())this.setState({stopPulling:true})
            else this.setState({stopPulling:false})
    ...
    async _onLoad(){
        // try {
            if(!this.state.loading && !this.state.stopPulling){
                ...
                this.baseRunSingleAPIWithRedoOption('getSearchInBuildingPlaceAuction', (async (v1, v2, v3,v4,v5,v6) => {return VSearchInThisPlaceAPI.getSearchInBuildingPlaceAuction(v1, v2, v3,v4,v5,v6) }).bind(this, this.Language, this.searchKeyword, this._filterData, this._sortData,this.buildingKey,this.paging), ((v) => {           
                    var resData = v// await VSearchInThisPlaceAPI.getSearchInBuildingPlaceAuction(this.Language, this.searchKeyword, this._filterData, this._sortData,this.buildingKey,this.paging);
                    if(resData.length!==0){
    ...
    constructor(props, context, ...args) {
        ...
        this._filterData = filterDAO.getInThisPlaceAuctionilterDataSearch();
