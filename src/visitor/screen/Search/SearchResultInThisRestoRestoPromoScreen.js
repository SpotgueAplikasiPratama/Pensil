...
export class SearchResultInThisRestoRestoPromoScreen extends SGBaseScreen {
    ...
    async _onRefreshAllItem(resetPaging = false) {
        ...
        if(resetPaging){
            ...
            this.baseAddAPIParallel('getSearchInRestoRestoPromo', (async (v1,v2,v3,v4,v5,v6) => { return VSearchInThisRestoAPI.getSearchInRestoRestoPromo(v1,v2,v3,v4,v5,v6); }).bind(this, this.Language, this.searchKeyword, this._filterData, this._sortData, this.restoKey,this.paging), ((v) => {
                this.data = v;
                if(v.length<SGHelperType.getPaging())this.setState({stopPulling:true})
                else this.setState({stopPulling:false})
            }).bind(this),  null);
    
            // VSearchInThisRestoAPI.getSearchInRestoRestoPromo(this.Language, this.searchKeyword, this._filterData, this._sortData, this.restoKey,this.paging).then((v) => {
            //     this.data = v;
    ...
    async _onRefresh() {
        ...
        if(!this.refresh && !this.state.loading){
            ...
            this.baseRunSingleAPIWithRedoOption('getSearchInRestoRestoPromo', (async (v1, v2, v3, v4, v5,v6) => { return VSearchInThisRestoAPI.getSearchInRestoRestoPromo(v1, v2, v3, v4, v5,v6) }).bind(this, this.Language, this.searchKeyword, this._filterData, this._sortData, this.restoKey,this.paging), ((v) => {
            this.data = v
            this.pagingCounter = this.data.length
            if(v.length<SGHelperType.getPaging())this.setState({stopPulling:true})
            else this.setState({stopPulling:false})
    ...
    async _onLoad(){
            if(!this.state.loading && !this.state.stopPulling){
                ...
                this.baseRunSingleAPIWithRedoOption('getSearchInRestoRestoPromo', (async (v1, v2, v3,v4,v5,v6) => {  return VSearchInThisRestoAPI.getSearchInRestoRestoPromo(v1, v2, v3,v4,v5,v6) }).bind(this, this.Language, this.searchKeyword, this._filterData, this._sortData, this.restoKey,this.paging), ((v) => {           
                var resData =  v//await VSearchInThisRestoAPI.getSearchInRestoRestoPromo(this.Language, this.searchKeyword, this._filterData, this._sortData, this.restoKey,this.paging);
                if(resData.length!==0){
    ...
    constructor(props, context, ...args) {
        ...
        this._filterData = filterDAO.getInThisRestoRestoPromoFilterDataSearch();
        this._sortData = sortDAO.getRestoPromoSearchInRestoSortData(this.Language.toUpperCase());
    ...
    render() {
        ...
        return (
            <RootView dummyStatusBar dummyHeaderBar accessible={true} accessibilityLabel={'SearchResultRestoPromoScreenRootView'} style={style.mainContainer}>
                <RibbonHeader imageSetting={this.imageSetting} title={SGLocalize.translate("SearchResultRestoPromoScreen.screenTitle")}></RibbonHeader>
                {this.alreadyMount ?
                    this.data.length !== 0 ?
