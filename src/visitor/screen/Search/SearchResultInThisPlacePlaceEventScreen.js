...
export class SearchResultInThisPlacePlaceEventScreen extends SGBaseScreen {
    ...
    async _onRefreshAllItem(resetPaging = false) {
        ...
        if(resetPaging){
            ...
            this.baseAddAPIParallel('getSearchInBuildingPlacePlaceEvent', (async (v1,v2,v3,v4,v5,v6) => { return VSearchInThisPlaceAPI.getSearchInBuildingPlacePlaceEvent(v1,v2,v3,v4,v5,v6); }).bind(this,this.Language, this.searchKeyword, this._filterData, this._sortData, this.buildingKey,this.paging), ((v) => {
                this.data = v;
    ...
    async _onRefresh() {
        ...
        if(!this.refresh && !this.state.loading){
            ...
            this.baseRunSingleAPIWithRedoOption('getSearchInBuildingPlacePlaceEvent', (async (v1, v2, v3, v4, v5,v6) => { return VSearchInThisPlaceAPI.getSearchInBuildingPlacePlaceEvent(v1, v2, v3, v4, v5,v6) }).bind(this,this.Language, this.searchKeyword, this._filterData, this._sortData, this.buildingKey,this.paging), ((v) => {
            this.data = v
            this.pagingCounter = this.data.length
            if(v.length<SGHelperType.getPaging())this.setState({stopPulling:true})
            else this.setState({stopPulling:false})
    ...
    async _onLoad(){
        if(!this.state.loading && !this.state.stopPulling){
            ...
            this.baseRunSingleAPIWithRedoOption('getSearchInBuildingPlacePlaceEvent', (async (v1, v2, v3,v4,v5,v6) => {  return VSearchInThisPlaceAPI.getSearchInBuildingPlacePlaceEvent(v1, v2, v3,v4,v5,v6) }).bind(this, this.Language, this.searchKeyword, this._filterData, this._sortData, this.buildingKey,this.paging), ((v) => {           
                var resData = v// await VSearchInThisPlaceAPI.getSearchInBuildingPlacePlaceEvent(this.Language, this.searchKeyword, this._filterData, this._sortData, this.buildingKey,this.paging);
                if(resData.length!==0){
    ...
    constructor(props, context, ...args) {
        ...
        this._filterData = filterDAO.getInThisPlacePlaceEventFilterData();
        this._sortData = sortDAO.getPlaceEventSearchSortData(this.Language.toUpperCase());
    ...
    render() {
        ...
        console.log('SearchResultInThisPlacePlaceEventScreen')
        return (
