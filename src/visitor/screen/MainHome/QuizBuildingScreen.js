...
import { tbBQuizAPI } from '../../api/tbBQuizAPI';
import { VRewardAPI } from '../../api/VRewardAPI';

export class QuizBuildingScreen extends SGBaseScreen {
    ...
    async _onRefreshAllItem() {
        ...
        this.baseAddAPIParallel('tbBQuizAPI', (async (v1) => { return tbBQuizAPI.GetBuildingQuizByID(v1) }).bind(this, this.fID), ((v) => {
            this.quizData = v;
        ...
        this.baseAddAPIParallel('GetBuildingQuizUserTotalAnswer', (async (v1) => { return tbBQuizAPI.GetBuildingQuizUserTotalAnswer(v1) }).bind(this, this.fID), ((v) => {
            this.totalAnswer =v;
    ...
    async _refreshGetTenantQuizUserTotalAnswer(){
        this.baseRunSingleAPIWithRedoOption('GetBuildingQuizUserTotalAnswer',(async (v1) => { return tbBQuizAPI.GetBuildingQuizUserTotalAnswer(v1) }).bind(this, this.fID), ((v) => {
             this.totalAnswer = v;
             if(this.totalAnswer.totalWrong >= this.quizData.fMaxRetry)
             {
                 this.finished = true
                ...
                () => {
                    if(this.answer == this.quizData.fAnswerIndex){
                        SGDialogBox.showSuccess(null, SGLocalize.translate("AlertMessage.Success"), SGLocalize.translate('QRQuiz.CorrectAnswerText'), SGLocalize.translate("AlertMessage.OK"), () => { 
                            this.baseRunSingleAPIWithRedoOption('SurpriseRewardsOpenBuildingQRQuiz', (async (v1,v2) => { return VRewardAPI.SurpriseRewardsOpenBuildingQRQuiz(v1,v2) }).bind(this,this.quizData.fBuildingKey,this.quizData.fID), (async (v) => {
                                this.surpriseReward = v;
                                this.finished = true
                                if (this.surpriseReward.fID !== null) {
                                    this.onShowReward()
                                    this.answerXUser = {fID:null,fBuildingKey:this.quizData.fBuildingKey,fUserKey:this.currentUser,fQuizKey:this.quizData.fID,fAnswerIndex:this.answer,fAnswerJSON:this.answerJSON,fResult:'correct',fRewardKey:this.surpriseReward.fRewardKey,fRedeemRewardKey:this.surpriseReward.fMysteryBoxKey,fActive:'Y',fCreatedByID:this.currentUser,fCreatedDate:new Date(),fLastModifiedByID:this.currentUser,fLastModifiedDate:new Date()}
                                    this.baseRunSingleAPIWithRedoOption('SubmitBuildingQuizAnswer', (async (v1) => { return tbBQuizAPI.SubmitBuildingQuizAnswer(v1) }).bind(this,this.answerXUser), (async (v) => {
                                        await this._refreshGetTenantQuizUserTotalAnswer();
                                    }).bind(this),  null,  SGHelperGlobalVar.getVar("ResponTimes"));
                                } else {
                                    this.surpriseReward = { fID: null, fRewardID: { fTargetName: '', fShortDescription: '', fImageJSON: [] }, fRewardEN: { fTargetName: '', fShortDescription: '', fImageJSON: [] }, fRewardCN: { fTargetName: '', fShortDescription: '', fImageJSON: [] } }
                                    this.answerXUser = {fID:null,fBuildingKey:this.quizData.fBuildingKey,fUserKey:this.currentUser,fQuizKey:this.quizData.fID,fAnswerIndex:this.answer,fAnswerJSON:this.answerJSON,fResult:'correct',fRewardKey:null,fRedeemRewardKey:null,fActive:'Y',fCreatedByID:this.currentUser,fCreatedDate:new Date(),fLastModifiedByID:this.currentUser,fLastModifiedDate:new Date()}
                                    this.baseRunSingleAPIWithRedoOption('SubmitBuildingQuizAnswer', (async (v1) => { return tbBQuizAPI.SubmitBuildingQuizAnswer(v1) }).bind(this,this.answerXUser), (async (v) => {
                                        await this._refreshGetTenantQuizUserTotalAnswer();
                                    }).bind(this),  null,  SGHelperGlobalVar.getVar("ResponTimes"));
                                }
                        ...
                        this.answerXUser = {fID:null,fBuildingKey:this.quizData.fBuildingKey,fUserKey:this.currentUser,fQuizKey:this.quizData.fID,fAnswerIndex:this.answer,fAnswerJSON:this.answerJSON,fResult:'wrong',fRewardKey:null,fRedeemRewardKey:null,fActive:'Y',fCreatedByID:this.currentUser,fCreatedDate:new Date(),fLastModifiedByID:this.currentUser,fLastModifiedDate:new Date()}
                        this.baseRunSingleAPIWithRedoOption('SubmitBuildingQuizAnswer', (async (v1) => { return tbBQuizAPI.SubmitBuildingQuizAnswer(v1) }).bind(this,this.answerXUser), (async (v) => {
                            await this._refreshGetTenantQuizUserTotalAnswer();
                        }).bind(this),  null,  SGHelperGlobalVar.getVar("ResponTimes"));
                        this.answer = -1
                ...
                <SGPopView accessible={true} accessibilityLabel={'QuizPopView'} vPos={'Top'} animationType={'slideUp'}  popViewID={this.pvID} >
                     <View accessible={true} accessibilityLabel={'QuizRewardView'} style={style.rewardPV}>
                         <View accessible={true} accessibilityLabel={'QuizHeaderRewardView'} style={style.headerPV}>
                             ...
                             <Text accessible={true} accessibilityLabel={'QuizRewardText'} style={style.textPV2} preset={Text.preset.titleH4_5B}>{tR('mallHomeScreen.RewardText')} {surpriseReward['fReward' + language].fTargetName}</Text>
