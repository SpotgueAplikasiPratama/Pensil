...
export class CheckOutButtonSmall extends SGBaseContainer {
    createStyleSheet() {
    ...
    render() {
        ...
        return (
            <View accessible={true} accessibilityLabel={'CheckOutButtonRootView'} style={style.mainView}>
                <Button accessible={true} accessibilityLabel={'CheckOutButtonIcon'} preset={Button.preset.red} shadow textPreset={Text.preset.heading9B} style={style.button} label={SGLocalize.translate("mallHomeScreen.buttonCheckOut")} onPress={this._iconPressed.bind(this)}></Button>
            </View>
        )
    }
}
