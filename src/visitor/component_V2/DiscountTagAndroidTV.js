...
export class DiscountTagAndroidTV extends SGBaseContainer {
    ...
    createStyleSheet() {
        ...
        return StyleSheet.create({
            tag: { alignSelf: 'flex-start', resizeMode: 'stretch', backgroundColor: '#E24444', alignItems: 'center', justifyContent: 'center', marginTop: -1 * p, marginRight: - 2 * p, borderBottomLeftRadius: 2 * p, borderTopRightRadius:  p },
    ...
    render() {
        ...
        return (
            <View accessible={true} accessibilityLabel={'DiscountTagRootImage'} style={style.tag}>
                <Text accessible={true} accessibilityLabel={'DiscountTagDiscountTotal'} preset={Text.preset.h12B} style={style.title}>{this._calculateDiscount()}%</Text>
                <Text preset={Text.preset.h12B} style={style.title}>OFF</Text>
            </View>
        );
    }
}
