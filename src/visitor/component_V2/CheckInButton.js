...
export class CheckInButton extends SGBaseContainer {
    createStyleSheet() {
    ...
    render() {
        ...
        return (
            <View accessible={true} accessibilityLabel={'CheckInButtonRootView'} style={style.mainView}>
                <Button accessible={true} accessibilityLabel={'CheckInButtonIcon'} preset={Button.preset.green} shadow textPreset={Text.preset.titleH3B} style={style.button} label={SGLocalize.translate("mallHomeScreen.buttonCheckIn")} onPress={this._iconPressed.bind(this)}></Button>
            </View>
        )
    }
}
