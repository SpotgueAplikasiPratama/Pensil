...
export class StorePromoDetailHeader extends SGBaseContainer {
    createStyleSheet = (whp) => {
        ...
        return StyleSheet.create({
            ...
            textFooterContent: { color: '#bebebe', maxWidth: w * 0.6,marginVertical:0 },
    ...
    whatsappEnjoyer(data) {
        try {
            ...
            var jsonInput = { fID: '', fContentType: 'Whatsapp',  fTargetKey: this.props.storeKey, fUserKey: '', fActive: 'Y', fCreatedByID: '', fCreatedDate: new Date(), fLastModifiedByID: '', fLastModifiedDate: new Date() }
            ...
            <View accessible={true} accessibilityLabel={'EventDetailHeaderRootView'} style={style.mainContainer}>
                <View accessible={true}>
                    ...
                    <View accessible={true} style={style.placeAndIconContainer}>
                        <TouchableOpacity onPress={() => { SGHelperNavigation.navigatePush(this.props.navigator, 'StoreHome', { contentKey: this.props.storeKey }) }}>
                            <View accessible={true} accessibilityLabel={'EventDetailHeaderFooterView'} style={style.placeContainer}>
                                ...
                                <View accessible={true} accessibilityLabel={'EventDetailHeaderFooterTextView'} style={style.footerTextView}>
                                    <Text accessible={true} accessibilityLabel={'EventDetailHeaderFooterName'} preset={Text.preset.titleH2B} style={style.textFooterName} numberOfLines={2} >{this.props.footerName}</Text>
                                    ...
                                    <Text accessible={true} accessibilityLabel={'EventDetailHeaderFooterCategory'} hidden={this.props.footerCategory ? false : true} preset={Text.preset.titleH5B} style={style.textFooterContent} numberOfLines={1}>{VisitorHelper.getLocalizeDataFromLookUp('StoreCategory',this.props.footerCategory,this._language)}</Text>
