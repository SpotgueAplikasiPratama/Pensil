...
export class AvailableMyParking extends SGBaseContainer {
    createStyleSheet = (whp) => {
        var { w, h, p } = whp;
        return StyleSheet.create({
            header: { width: w, paddingLeft: p * 4, paddingRight: p * 10, justifyContent: 'space-between', alignItems:'flex-start', backgroundColor: '#FFFFFF', paddingVertical: p },
