...
export class RestoEventSliderAndroidTV extends SGBaseContainer {
    ...
    render() {
        ...
        return (
            <View accessible={true} accessibilityLabel={'StorePromoMainContainer'} style={style.mainContainer}>
                ...
                <ViewPager accessible={true} accessibilityLabel={'StorePromoSliderViewPager'} style={style.sliderContainer} pageIndicatorStyle={{width:w,height:h}} initialPage={0} halfWidth showPageIndicator={true} transitionStyle={'scroll'} pageIndicatorStyle={{ position: 'absolute', bottom: 0 * p, flexDirection: 'row', alignSelf: 'center' }}>
                    {
                        data.map((x) => {
                            return (
