...
export class StoreCheckInHistoryCard extends SGBaseContainer {
    ...
    render() {
        ...
        return (
            <TouchableOpacity onPress={() => SGHelperNavigation.navigatePush(this.props.navigator, 'StoreHome', { contentKey: this.data.contentKey })}>
                <View accessible={true} accessibilityLabel={'StoreCheckInHistoryCardRootView'} style={style.mainContainer}>
                    <View accessible={true} accessibilityLabel={'StoreCheckInHistoryCardImageView'} style={style.leftContainer}>
                        <Image accessible={true} accessibilityLabel={'StoreCheckInHistoryCardImage'} style={style.image} source={{ uri: this.dataContent.fStoreImageJSON[0][this.props.imageSetting].uri }}></Image>
                    </View>
                    <View accessible={true} style={style.rightContainer}>
                        <View accessible={true} style={style.detail}>
                            <Text accessible={true} accessibilityLabel={'StoreCheckInHistoryCardStoreName'} preset={Text.preset.titleH3B} numberOfLines={1} style={style.nameText}>{this.dataContent.fStoreName.toUpperCase()}</Text>
                            <Text accessible={true} accessibilityLabel={'StoreCheckInHistoryCardLocationPlaceName'} preset={Text.preset.titleH4_5B} numberOfLines={1} style={style.typeAndLocationText}>{this.data['fBuildingName' + this.props.language.toUpperCase()]}</Text>
                            <Text accessible={true} accessibilityLabel={'StoreCheckInHistoryCardCIText'} preset={Text.preset.titleH5} numberOfLines={1} style={style.lastCheckInText}>{this.props.lastCheckInLabel}</Text>
                        ...
                        <View accessible={true} style={style.lastVisited}>
                            <LastVisitedTag accessible={true} accessibilityLabel={'StoreCheckInHistoryCardLastVisitesTag'} textPreset={Text.preset.h11B} value={this.data.fLastVisited} imageSetting={this.imageSetting} styleTag={style.tagIcon} styleText={style.tagText}></LastVisitedTag>
                        </View>
                    </View>
