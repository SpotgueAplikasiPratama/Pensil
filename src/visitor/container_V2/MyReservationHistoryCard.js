...
export class MyReservationHistoryCard extends SGBaseContainer {
                    ...
                    <View accessible={true} accessibilityLabel={'MyReservationActiveCardContainerView'} style={style.containerView2}>
                        ...
                        <View accessible={true} accessibilityLabel={'MyReservationActiveCardMidView'} style={style.containerView2Mid}>
                            ...
                            <View accessible={true} accessibilityLabel={'MyReservationActiveCardPersonView'} style={style.contentView}>
                                ...
                                <Text accessible={true} accessibilityLabel={'MyReservationActiveCardNumbPerson'} preset={Text.preset.titleH5B} style={style.text2}>{data.fNumberOfPerson} {SGLocalize.translate('tabWaitingList.LabelPerson')}</Text>
                            </View>
                        </View>
                        <View accessible={true} accessibilityLabel={'MyReservationActiveCardBottomView'} style={style.containerView2Bottom}>
                            <Text accessible={true} accessibilityLabel={'MyReservationActiveCardStatus'} preset={Text.preset.titleH3B} style={style.textStatus}>{data.fStatus.toUpperCase()}</Text>
                        </View>
