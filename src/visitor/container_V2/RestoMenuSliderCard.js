...
export class RestoMenuSliderCard extends SGBaseContainer {
    createStyleSheet = (whp) => {
        var { w, h, p } = whp;
        return StyleSheet.create({
            mainContainer: { width: this.props.listMode ? w * 0.45 : w * 0.36, height: this.props.listMode ? w * 0.7 : w * 0.55, backgroundColor: '#FFFFFF', borderRadius: p * 3, justifyContent: 'flex-start', marginVertical: 0, marginBottom: this.props.listMode ? p * 5 : null, paddingVertical: 0, marginLeft: this.props.listMode ? p * 2 : 0, marginRight: this.props.listMode ? p * 2 : p * 5 },
            ...
            menuNameContainer: { width: this.props.listMode ? w * 0.45 : w * 0.36, paddingHorizontal: this.props.listMode ? p * 2 : null, height: this.props.listMode ? w * 0.1 : w * 0.09, justifyContent: 'flex-start', marginVertical: p },
    ...
    render() {
        ...
        return (
            <TouchableOpacity onPress={() => SGHelperNavigation.navigatePush(this.props.navigator, 'RestoMenuDetail', { contentKey: data.key, restoKey: data.restoKey,data:data})}>
                <View shadow accessible={true} accessibilityLabel={'RestoMenuSliderCardRootView'} style={style.mainContainer}>
                    ...
                    <View accessible={true} style={style.bottomContainer}>
                        ...
                        <View accessible={true} style={style.rightContainer}>
                            <CardIconButtonLike onIconPressed={this.props.onLike} accessible={true} accessibilityLabel={'RestoMenuSliderCardLikeIcon'} likePackage={this.props.likePackage} hideText={true} navigator={this.props.navigator} contentType='RestoMenu' contentKey={data.key} active={data.fUserLikedThis} type={'like'} ></CardIconButtonLike>
                        </View>
                    </View>
