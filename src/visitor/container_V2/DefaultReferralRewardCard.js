...
export class DefaultReferralRewardCard extends SGBaseContainer {
    ...
    constructor(props, context, ...args) {
        ...
        this.dataContentReward = this.data['fContent' + this.props.language.toUpperCase()];
        this.dataContentFooter = this.data['fContentType' + this.props.language.toUpperCase()];
    ...
    render() {
        ...
        this.data=this.props.data
        return (
            <TouchableOpacity onPress={() => SGHelperNavigation.navigatePush(this.props.navigator, 'ReferralRewardDetail', { contentKey: this.data.fID, fType: this.data.fType, myPoint: this.props.myPoint })}>
                <View accessible={true} accessibilityLabel={'DefaultReferralRewardCardRootView'} style={style.mainContainer}>
                    <View accessible={true} style={style.topContainer}>
                        ...
                        <View accessible={true} style={style.totalAvailable}>
                            <Text accessible={true} accessibilityLabel={'TradePoint'} preset={Text.preset.titleH4B} style={style.tradePoint}>{SGLocalize.translate('CarouselRewardCard.referralPriceLabel',{count:this.data.fReferralPrice})}</Text>
