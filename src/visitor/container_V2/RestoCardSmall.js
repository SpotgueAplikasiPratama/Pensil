...
export class RestoCardSmall extends SGBaseContainer {
            ...
            <TouchableOpacity onPress={() => { this.onCardPress(this.props.screen, this.props.contentKey) }}>
                <View accessible={true} accessibilityLabel={'RestoCardSmallRootView'} shadow shadowIntensity={0.6} style={style.mainContainer}>
                    <View accessible={true} accessibilityLabel={''} style={style.imageContainer}>
                        <Image accessible={true} accessibilityLabel={'RestoCardSmallImage'} style={style.sliderImage} source={{ uri: this.props.image }}></Image>
                    </View>
                    <View accessible={true} accessibilityLabel={'RestoCardSmallTextView'} style={style.textContainer}>
                        <Text accessible={true} accessibilityLabel={'RestoCardSmallContentText'} numberOfLines={1} preset={Text.preset.titleH4B} style={style.sliderText}>{this.props.restoName}</Text>
                        <Text accessible={true} accessibilityLabel={'RestoCardSmallPlaceNameText'} numberOfLines={1} preset={Text.preset.titleH5} style={style.sliderText}>{this.props.placeName}</Text>
                    </View>
                </View>
            </TouchableOpacity>
        );
