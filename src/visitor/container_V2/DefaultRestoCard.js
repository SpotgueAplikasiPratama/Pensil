...
export class DefaultRestoCard extends SGBaseContainer {
    createStyleSheet = (whp) => {
        ...
        return StyleSheet.create({
            ...
            typeAndLocationText: {color: '#989898', marginTop: 0, marginBottom: p * 2},
    ...
    render() {
        ...
        return (
            <TouchableOpacity onPress={() => SGHelperNavigation.navigatePush(this.props.navigator, 'RestoHome', { contentKey: this.props.contentKey })}>
                ...
                <View accessible={true} accessibilityLabel={'DefaultRestoCardRootView'} style={style.mainContainer}>
                    <View accessible={true} style={style.topContainer}>
                        <View accessible={true} accessibilityLabel={'DefaultRestoCardContentView'} style={style.leftContainer}>
                            <Image accessible={true} accessibilityLabel={'DefaultRestoCardContentImage'} shadow style={style.image} source={{ uri: this.props.contentImage }}></Image>
                            <Text accessible={true} accessibilityLabel={'DefaultRestoCarContentLike'} preset={Text.preset.titleH6} style={style.text1}>{this.props.contentLikeCount} {this.props.likeText}</Text>
                        </View>
                        <View accessible={true} accessibilityLabel={'DefaultRestoCardContainerView2'} style={style.centerContainer}>
                            <View accessible={true} style={style.restoDetailsContainer}>
                                <Text accessible={true} accessibilityLabel={'DefaultRestoCardRestoName'} preset={Text.preset.titleH3B} numberOfLines={2} style={style.restoNameText}>{this.props.restoName ? (this.props.restoName).toUpperCase() : ''}</Text>
                                
                                <Text accessible={true} accessibilityLabel={'DefaultRestoCardRestoCategory'} preset={Text.preset.titleH5B} numberOfLines={1} style={style.categoryNameText}>{VisitorHelper.getLocalizeDataFromLookUp('RestoCategory',this.props.restoCategory,this._language)}, {VisitorHelper.getLocalizeDataFromLookUp('CuisineCategory',this.props.restoCuisine,this._language)}</Text>
                                <Text accessible={true} accessibilityLabel={'DefaultRestoCardRestoPreference'} preset={Text.preset.titleH5B} numberOfLines={1} style={style.typeAndLocationText}>{SGLocalize.translate("isHalal." + this.props.isHalal)} {SGLocalize.translate("isVegetarian." + this.props.isVegetarian)}</Text>
                            ...
                            <View accessible={true} accessibilityLabel={'DefaultRestoCardIconButtonView'} style={style.iconContainer}>
                                <CardIconButtonLike onIconPressed={this.props.onLike} accessible={true} accessibilityLabel={'DefaultRestoCardIconLike'} likePackage={this.props.likePackage} navigator={this.props.navigator} contentType='Resto' contentKey={this.props.contentKey} active={this.props.like} type={'like'} style={style.throwWHP}></CardIconButtonLike>
                                <CardIconButtonNotification onIconPressed={this.props.onNotification}  accessible={true} accessibilityLabel={'DefaultRestoCardIconComment'} navigator={this.props.navigator} contentType='Resto' contentKey={this.props.contentKey} active={this.props.notification} type={'notification'} style={style.throwWHP}></CardIconButtonNotification>
                                <CardIconButtonFavorite onIconPressed={this.props.onFavorite} accessible={true} accessibilityLabel={'DefaultRestoCardIconShare'} navigator={this.props.navigator} contentType='Resto' contentKey={this.props.contentKey} active={this.props.favorite} type={'favorite'} style={style.throwWHP}></CardIconButtonFavorite>
                            </View>
                        </View>
                        <View accessible={true} style={style.rightContainer}>
                            {this.props.lastVisited !== null &&
                            <LastVisitedTag accessible={true} accessibilityLabel={'DefaultRestoCardLastVisited'} value={this.props.lastVisited} imageSetting={this.imageSetting} style={style.throwWHP} styleTag={style.tagIcon} styleText={style.tagText}></LastVisitedTag>
                            }
                        </View>
                    </View>
